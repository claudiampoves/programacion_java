...
public class UtilidadesEjercicios {
	...
	/**
	 * Pinta el menú por defecto.
	 */
	public static void pintaMenu() {
		String [] menuPorDefecto = {"1.- Validar email.", "2.- Printar cuadrado.", "3.- Mostrar datos.", "4.- Salir."};
		pintaMenu (menuPorDefecto);
	}
	
	public static void pintaMenu(String menu, String caracterSeparador) {
		System.out.println(menu);
		pintaMenu(menu.split(caracterSeparador));
	}
