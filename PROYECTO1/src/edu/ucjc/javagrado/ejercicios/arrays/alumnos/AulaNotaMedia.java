...
public class AulaNotaMedia {
	...
	public static void main(String[] args) {
		...
		Asignatura asignatura4 = new Asignatura("Asinatura4", 7.5);
		Asignatura[] asignaturasAlumno2 = {asignatura3, asignatura4};
		Alumno alumno2 = new Alumno("Nombre2", "Apellido2", asignaturasAlumno2);
		
		//Creo Alumno3
		Asignatura asignatura5 = new Asignatura("Asinatura5", 9.0);
		Asignatura asignatura6 = new Asignatura("Asinatura6", 4.5);
		...
		//System.out.println("La nota media más alta es " + notaMasAlta + " del alumno " + nombreAlumnoNotaMasAlta);
		System.out.println("La nota media más alta es " + notaMasAlta + " del alumno " + alumnoNotaMasAlta.getNombre());
	}
